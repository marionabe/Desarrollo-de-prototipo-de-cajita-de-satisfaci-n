//Codigo guia 3 para establecer comunicacion(lectura y escritura) entre Arduino y memoria flash

//Este codigo no ha sido probado todavia y debe ser modificado para la comunicacion con el Fio V3
//Se obtuvo de un ejemplo propuesto('readWriteString') del repositorio:https://github.com/Marzogh/SPIMemory/tree/master
